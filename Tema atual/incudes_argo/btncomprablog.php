...
<!---->
       <div class="modal-footer" style="margin-top:15px!important;">
		...
		<form method="post" action="http://www.argohost.net/core/cart.php?a=add&pid=32&productconfig=1&skipconfig=configdomains">
...
<!---->
       <div class="modal-footer">
		<form method="post" action="http://www.argohost.net/core/cart.php?a=add&pid=33&productconfig=1&skipconfig=configdomains">
...
<!---->
       <div class="modal-footer">
		...
		<form method="post" action="http://www.argohost.net/core/cart.php?a=add&pid=34&productconfig=1&skipconfig=configdomains">
