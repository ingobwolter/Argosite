...
<div class="googleplus" style="position:fixed; bottom: 41%; left:2%;z-index:1001;width:90px;">
   ...
   <div style="float:left;width:50px;margin-left:-8px;">
...
<div class="boxer">
                    	<center>
                        	...
                        	<a href="http://www.argohost.net/infraestrutura.php" type="button" class="btn btn-danger" rel="nofollow">Saiba mais</a>
                        </center>	 	
                   	</div>
<div class="boxer">
                		<center>
                        	...
                        	<a href="http://www.argohost.net/argohost.php" type="button" class="btn btn-danger" rel="nofollow">Saiba mais</a>
						</center>
                   	</div>
<div class="boxer">
                		<center>
                			...
                			<h3 style="color:#2C3E50;">A qualidade do nosso atendimento é assunto sério!</h3><br>
                       		<a href="http://www.argohost.net/atendimento.php" class="btn btn-danger" rel="nofollow">Saiba mais</a>
						</center>	
                   	</div>
           </div>   
            </hgroup>
        	...
        	<div class="container" style="padding-left:10%;">
         		<div class="boxertwo">
                     <center>
                		   ...
                		   <h3 style="color:#DA4A37;">Chamados<br>por e-mail<br><hr><span font-size:10px;>Abertura de chamado</span></h3><br><br>
                     </center>
                </div>
         		<div class="boxertwo">
                     <center>
                		   ...
                		   <h3 style="color:#DA4A37;">Suporte <br>Help desk<br><hr><span font-size:10px;>Chat com nossos analistas</h3><br><br>
                     </center>
                </div>
               	<div class="boxertwo">
                	 <center>
                ...
                <div class="boxertwo">
                	<center>
                			 ...
                			 <h3 style="color:#DA4A37;">Ligue para<br> 4002 2552<br><hr><span font-size:10px;>Fale direto com os analistas</h3><br><br>
					</center>	
	            </div>
            </div>    
...
<section class="product-detail-photo" id="bg-image-4" data-speed="20" data-type="background" data-offset="-290"></section>
    <article class="product-detail-content" id="inf" data-speed="30" data-type="background"   style="border-bottom:6px solid #DA4A37;">
       ...
       <div class="container_12" span="infra">              
        	<div class="grid_4"> <h4><img src="Content/images/icones/hospedar-site-ok.svg" alt="Hospedar sites"  width="50" height="50">&nbsp;&nbsp;Antivírus no cPanel</h4>
         	Controle o antivírus do seu domínio direto no painel da hospedagem.</div>  
            <div class="grid_4"> <h4><img src="Content/images/icones/hospedar-site-ok.svg" alt="Hospedar sites"  width="50">&nbsp;Controle Próprio de SPAM</h4>
            Controle o bloqueio de SPAM de forma independente e autônoma.</div> 
            <div class="grid_4"> <h4><img src="Content/images/icones/hospedar-site-ok.svg" alt="Hospedar sites"  width="50" height="50">&nbsp;&nbsp;SQL Server Incluso</h4>
            Opções de Hospedagem Windows com SQL Server já incluso no plano.</div> 
            <div class="grid_4"> <h4><img src="Content/images/icones/hospedar-site-ok.svg" alt="Hospedar sites"  width="50" height="50">&nbsp;&nbsp;Site Seguro - Ip dedicado</h4>
            Hospedagem de site seguro com IP dedicado e certificado SSL.</div> 
            <div class="grid_4"> <h4><img src="Content/images/icones/hospedar-site-ok.svg" alt="Hospedar sites"  width="50" height="50">&nbsp;&nbsp;Primeira Hospedagem Blog</h4>
            Wordpress com temas adicionais e plugins pré-instalados, hospede e saia alimente seu blog.</div> 
            <div class="grid_4"> <h4><img src="Content/images/icones/hospedar-site-ok.svg" alt="Hospedar sites" width="50" height="50">&nbsp;&nbsp;ASP .NET ou PHP</h4>
            Escolha sua linguagem e opte pela Hospedagem Windows ou Hospedagem Linux.</div>  
       	</div>
       </div>
       <br><center style="position: relative; bottom: -16px; margin-bottom: 30px;"><a class="btn btn-danger" href="http://argohost.net/infraestrutura.php">Confira já!</a></center>
</article>
