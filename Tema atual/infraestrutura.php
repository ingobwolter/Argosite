...
<head>
        ...
        <title>ArgoHost Soluções em hospedagem . Hospedar site, blog e loja virtual - Infraestrutura</title>
...
<article class="product-detail-content"style="display:none; margin:0px !important;"></article>
<div class="clear" style="margin-top:40%;padding-left:10%;"></div>
    <div class="container"> 
        <div class="col-md-6" style="padding-left:16%;">
            <img src="Content/images/icones/aspasesquerda.svg" width="80px">
                <p style="color:#2b3d4f;font-size:22px;font-family:museo_light;">	   
                    A ArgoHost está constantemente<br>
                    preocupada em preparar sua<br> 
                    infraestrutura para atender a demanda<br> 
                    que cada produto exige, por isso cada<br>
                     serviço é tratado como único, sempre<br> 
                     com o lema Excelência por Produto.<br>
            <img src="Content/images/icones/aspasdireita.svg" width="80px" class="pull-right">        
                </p><br><br><br><br>     
        </div>    
       
        <div class="col-md-12" style="padding-left:16%;">
            <p style="color:#2b3d4f;font-size:88px;font-family:impact;">ESTRUTURA DE<br></p>
            <p style="color:#46719d;font-size:65px;font-family:impact;line-height:6px;">ALTA PERFORMANCE</p>
        </div><br><br>    

        <div class="col-md-12" style="padding-left:16%;padding-top:35px;">

            <span style="color:#2b3d4f;font-size:32.5px;font-family:impact;line-height:26.6px;text-transform:uppercase;letter-spacing:-0.3px">
                QUE GARANTE MAIOR DISPONIBILIDADE E<br>
            <span style="color:#2b3d4f;font-size:29.5px;font-family:impact;line-height:26px;text-transform:uppercase;letter-spacing:-0.3px">    
                ESCALABILIDADE DOS SERVIÇOS PRESTADOS.
            </span>
        </div><br><br>   

        <div class="col-md-10" style="padding-left:3%;padding-top:40px;"><br><br> 
            <img src="Content/images/icones/argohost-hospedagem-vendas.svg" width="620px" class="pull-right">
        </div>
         <div class="col-md-9" style="padding-left:16%;padding-left:16%;font-family:museo_regular;font-size:16px;margin-top:-25px;"><br><br>
            <ul class="nav nav-tabs" role="tablist" style="height:59px;">
              <li class="active"><a href="#marca" role="tab" data-toggle="tab">TI Verde</a></li>
              <li><a href="#historia" role="tab" data-toggle="tab">Data Center no <br>Brasil e EUA</a></li>
              <li><a href="#missao" role="tab" data-toggle="tab">Certificações</a></li>
              <li><a href="#visao" role="tab" data-toggle="tab">Parceiros</a></li>
              <li><a href="#valores" role="tab" data-toggle="tab">Fornecedores</a></li>
            </ul>
            <div class="tab-content" style="padding:27px;border-bottom:1px solid #ccc;box-sizing:border-box;border-radius:0px 0px 10px 10px;border-right: 1px solid #ccc;border-left: 1px solid #ccc;background-color:#fff;">
