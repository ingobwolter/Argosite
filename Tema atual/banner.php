...
<html>
<head>
        <link href="Content/images/icones/favicon.ico" rel="icon" type="image/x-icon"/> 
...
var WRInitTime=(new Date()).getTime();
     ...
     <!--<div id="boxcontainer">
       <div id="distancia">
         <div id="dentro">
                                <img src="core/templates/argohost/images/chat.png" alt="Atendimento ArgoHost" width="180px" style="position:absolute;top:-155px;">
           <center>
             <div id="distancia2">
               <div id="dentro2">
...
<div class="boxer">
           ...
           <center><a href="http://www.argohost.net/argohost.php" type="button" class="btn btn-danger" rel="nofollow">Saiba mais</a></center>
            </hgroup>
        </header>
</article>
...
<article class="product-detail-content" id="api" data-speed="10" data-type="background" style="border-bottom:6px solid #DA4A37;min-height:100px !important;">
      ...
      <div class="redes">    
		    	<center>
                        ...
                        <h2 style="color:#DA4A37;">Compartilhamos conhecimento e novidades, siga a ArgoHost!</h2>
...
<article class="product-detail-content" id="api" data-speed="10" data-type="background" style="border-bottom:6px solid #DA4A37;">
	   <header class="center">
        	...
        	<div class="container" style="padding-left:10%;">
         		<div class="boxertwo">
                     <center>
                            <a href="http://www.argohost.net/atendimento.php" rel="nofollow">
                           <img src="Content/images/icones/atendimento-email.svg" title="Suporte ArgoHost" width="100px" height="74px" style="padding-bottom:25px;" alt="Suporte ArgoHost">
                		   <h3 style="color:#2C3E50;">Chamados<br>por e-mail<br><hr><span font-size:10px;>Abertura de chamado</span></h3>
                            </a>
                     </center>
                </div>
         		<div class="boxertwo">
                     <center>
                		   ...
                		   <h3 style="color:#2C3E50;">Suporte <br>Help desk<br><hr><span font-size:10px;>Chat com nossos analistas</h3>
                            </a>
                     </center>
                </div>
               	<div class="boxertwo">
                	 <center>
                			...
                			<h3 style="color:#2C3E50;">Posso<br>
                			ajudar?<br><hr><span font-size:10px;>Chamados de emergência</h3>
                            </a>
					 </center>
                </div>
                <div class="boxertwo">
                	<center>
                            <a href="http://www.argohost.net/atendimento.php" rel="nofollow">
                			 ...
                			 <h3 style="color:#2C3E50;">Ligue para<br> 4002 2552<br><hr><span font-size:10px;>Fale direto com os analistas</h3>
                            </a>
					</center>	
	            </div>
            </div>    
		   ...
		   <div class="container">
                <center><a href="http://www.argohost.net/atendimento.php" class="btn btn-danger" rel="nofollow">Saiba mais</a></center>
           </div>     
</article>
...
<article class="product-detail-content" id="widgets" data-speed="5"  style="border-bottom:6px solid #2B3D4F;">
    <div class="container product-detail-layout-3">
        <header class="center">
            <hgroup class="product-headergroup">
                <h5 style="color:#2C3E50;font-family: open_sanslight,arial,verdana ! important; font-size:60px;text-align: center;">Inteligência no processo de vendas</h5>
                <h2 style="color:#DA4A37;">É preciso parar de vender o passado, para quem quer comprar o futuro.</h2>
                    ...
                    <div class="boxertre">
				 	...
				 	<center><a href="http://www.argohost.net/vendas.php" class="btn btn-danger" rel="nofollow">Saiba mais</a></center>
            </hgroup>
    	</header>
    </article>
        </div>
...
<section class="product-detail-photo" id="bg-image-4" data-speed="20" data-type="background" data-offset="-290"></section>
    <article class="product-detail-content" id="inf" data-speed="30" data-type="background" >
	   <header class="center">
            <hgroup>
          ...
          <div class="container">
       <div class="container_12" span="infra" style="text-align: center;">
	   <div style="float: left; text-align: right; width: 445px;"> 
        <br><br><br>
	   <h4 style="color: #2C3E50; text-transform: uppercase;">Site seguro com certificado SSL e IP dedicado</h4>
	   <font style="font-size: 14px;">Ter um site com ip dedicado e com certificado SSL oferece segurança para seus clientes, além disso o Google prioriza sites seguros nos resultados  de busca.</font>
	   <br><br>
	   <h4 style="color: #2C3E50; text-transform: uppercase;">Soluções de Email</h4>
	   <font style="font-size: 14px;">Através dos serviços de e-mail que a ArgoHost oferece você expande seus mercados e atinge seu público divulgando sua marca e seu nome com uma comunicação personalizada.</font>
	   <br><br>
	   <h4 style="color: #2C3E50; text-transform: uppercase;">Hospedagem para Blog Wordpress</h4>
	   <font style="font-size: 14px;">Hospedar um blog pequeno ou grande é muito fácil, seja você iniciante ou um blogueiro experiente, preparamos uma hospedagem para blog perfeita para sua necessidade.</font>
   	   <br><br>
	   <h4 style="color: #2C3E50; text-transform: uppercase;">ASP .NET PHP e HTML</h4>
	   <font style="font-size: 14px;">Usufrua da liberdade para programar na sua linguagem preferida e ter a certeza da perfeita execução do código. Escolha entre nossos planos de hospedagem Linux ou hospedagem Windows.</font>
	   
	   
	   </div>
	   
	   <div style="text-align: center; float: left;"> 
	   <img src="infraestrutura-argohost.svg" alt="Infraestrutura Argohost">
	   </div>
	   
	   
	   <div style="float: right; text-align: left;  width: 450px;"> 
	   <br><br><br>
	   <h4 style="color: #2C3E50; text-transform: uppercase;">Antivírus e Anti-spam na ArgoControle</h4>
	   <font style="font-size: 14px;">Sua Central do Cliente conta com um poderoso recurso para controlar a sensibilidade do serviço de antivírus e antispam no tratamento dos emails.</font>
	   <br><br>
	   <h4 style="color: #2C3E50; text-transform: uppercase;">Hospedagem Windows com SQL Server incluso</h4>
	   <font style="font-size: 14px;">Escolha entre planos com servidor SQL já inclusos na configuração, com recursos pré-alocados e reservados para que seu site ou sua aplicação tenha a disponibilidade que necessita.</font>
	   <br><br>
	   <h4 style="color: #2C3E50; text-transform: uppercase;">Hospedagem de emails</h4>
	   <font style="font-size: 14px;">O uso de uma hospedagem de email oferece flexibilidade na configuração das contas, espaço utilizado e segurança, através dos backups periódicos feitos pela ArgoHost.</font>
   	   <br><br>
	   <h4 style="color: #2C3E50; text-transform: uppercase;">Hospedagem Linux</h4>
	   <font style="font-size: 14px;">Hospede seu site em planos dimensionados perfeitamente para hospedagem de loja virtual, site institucional ou portais de pequeno e médio porte que atendem sua necessidade.</font>
       ...
       <br><center style="position: relative; bottom: -16px;"><a class="btn btn-danger" href="http://www.argohost.net/infraestrutura.php" rel="nofollow">Confira já!</a></center>
</article>
...
<div style="position:absolute;display:none;">
    ...
    <script type="text/javascript">
        ...
        po.src = '//www.argochat.argohost.net/index.php/por/chat/getstatus/(click)/internal/(position)/bottom_right/(ma)/br/(check_operator_messages)/true/(top)/350/(units)/pixels/(leaveamessage)/true/(department)/1/(theme)/1?r='+refferer+'&l='+location;
